    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-[#1a0f0f] to-[#0C0C0C] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div
                    className="absolute bottom-[-10%] right-[-5%] w-[600px] h-[600px] bg-gradient-to-tl from-brand-secondary/15 via-brand/10 to-transparent rounded-full blur-3xl animate-pulse"
                    style={{ animationDelay: "1s" }}
                ></div>
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-brand-accent/8 to-brand-secondary/8 rounded-full blur-3xl animate-pulse"
          ...
          `,
                ...
                <div className="absolute top-20 left-[12%] text-3xl opacity-20 animate-float">
                    📍
                </div>
                <div
                    className="absolute top-32 right-[18%] text-2xl opacity-15 animate-float"
                    style={{ animationDelay: "1.5s" }}
                >
                    🗺️
                </div>
                <div
                    className="absolute bottom-28 left-[20%] text-3xl opacity-20 animate-float"
                    style={{ animationDelay: "3s" }}
                >
                    ❤️
                </div>
                <div
                    className="absolute bottom-16 right-[15%] text-2xl opacity-15 animate-float"
                    style={{ animationDelay: "2.5s" }}
                >
                    ✨
                </div>
                <div
                    className="absolute top-1/3 left-[8%] text-xl opacity-10 animate-float"
                    style={{ animationDelay: "4s" }}
                >
                    🌍
                </div>
                <div
                    className="absolute top-1/2 right-[10%] text-xl opacity-10 animate-float"
            ...
            <div className="relative w-full max-w-md z-10">
                    ...
                    <div className="relative p-10">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="text-sm text-muted-foreground italic max-w-sm mx-auto leading-relaxed">
                                Pin the places you've been, and the stories
                                you've lived 🗺️✨
                            </p>
                        </div>
                        ...
                        <div className="space-y-3 mb-10">
                            <div className="group flex items-start gap-4 text-sm bg-gradient-to-br from-brand/10 via-brand/5 to-transparent border border-brand/30 rounded-2xl p-4 transition-all duration-500 hover:border-brand/70 hover:shadow-lg hover:shadow-brand/25 hover:translate-x-2 cursor-default relative overflow-hidden">
                                ...
                                <div className="relative flex-1 pt-1">
                                    <p className="text-foreground font-medium group-hover:text-brand-accent transition-colors">
                                        Unlimited pinory storage
                                    </p>
                ...
                >
                    <p className="text-muted-foreground text-sm italic">
                        ✨ Turn every trip into an everlasting memory
                    </p>
                </div>
            </div>
