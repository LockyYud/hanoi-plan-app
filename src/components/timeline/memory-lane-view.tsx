...
import { LocationNote, usePinoryStore } from "@/lib/store";
...
export function MemoryLaneView({
    ...
    const { setSelectedPinory } = usePinoryStore();
    ...
    const loadNotes = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.error("Could not load pinories");
            }
        } catch (error) {
            console.error("Error loading notes:", error);
            toast.error("Error loading pinories");
        } finally {
            setLoading(false);
        }
    };
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-muted-foreground">
                                No pinories in this time period
                            </p>
                        </div>
                    ) : (
                            ...
                            {sortedNotes.map((note, index) => (
                                <Card
                                    ...
                                    className={cn(
                                        ...
                                        sortBy === "custom" &&
                                            "cursor-move hover:bg-secondary/70"
                                    )}
