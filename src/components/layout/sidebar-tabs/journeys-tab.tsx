...
export function JourneysTab({
    ...
    const handleShowOnMap = (journey: Journey) => {
        ...
        const routeNotes: Pinory[] = journey.stops.map((stop) => {
            ...
            const openHours =
                (place.openHours as Record<string, unknown>) || {};
        ...
        toast.success(`Showing "${journey.title}" on map`);
    };
                ...
                {loadingJourneys ? (
                    ...
                    <div className="text-center py-8 sm:py-10 md:py-12 text-muted-foreground px-2">
                        ...
                        <p className="text-[10px] sm:text-xs text-muted-foreground mb-3 sm:mb-4">
                            Create a journey from your saved pinories
                        </p>
                        <Button
                            size="sm"
                            variant="outline"
                        ...
                        >
                            ...
                            <span className="xs:hidden">Create journey</span>
                        </Button>
                    </div>
                ) : (
