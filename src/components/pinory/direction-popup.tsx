    ...
    return (
        <div className="fixed inset-0 z-40 pointer-events-none">
            ...
            <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 pointer-events-auto px-4 w-full max-w-2xl">
                <Card
                    className={`shadow-2xl border border-border/50 rounded-2xl overflow-hidden bg-card/95 backdrop-blur-md transition-all duration-300 ${
                        isAnimated
                    ...
                    <div className="px-4 py-3 relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-3 flex-shrink-0">
                                <div className="relative p-2.5 bg-brand rounded-xl shadow-lg">
                                    <Navigation
                                        className="h-5 w-5 text-white"
                                        strokeWidth={2.5}
                                    />
                                    <div className="absolute inset-0 bg-brand rounded-xl blur-md opacity-50 -z-10"></div>
                                </div>
                            ...
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                                {/* Distance */}
                                <div className="flex items-center gap-2 bg-green-900/30 rounded-xl px-3 py-2 border border-green-700/40 shadow-sm">
                                    <Ruler
                                ...
                                {/* Duration */}
                                <div className="flex items-center gap-2 bg-brand-secondary/20 rounded-xl px-3 py-2 border border-brand-secondary/40 shadow-sm">
                                    <Clock
                                        className="h-4 w-4 text-brand-accent flex-shrink-0"
                                        strokeWidth={2.5}
                                    />
                                    <span className="text-sm font-black text-brand-accent whitespace-nowrap">
                                        {formatDuration(routeInfo.duration)}
                                    </span>
                                </div>

                                {/* Status indicator - Enhanced */}
                                <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-brand/10 rounded-lg border border-brand/30">
