...
// Category configuration with both emoji and Lucide icons
  ...
  return (
    ...
    >
      ...
      >
        ...
        {mood ? (
          <span className={cn("leading-none", config.emoji)}>{mood}</span>
        ) : (
          <>
            {/* Show emoji on small screens, Lucide icon on larger screens */}
            <span className={cn("leading-none sm:hidden", config.emoji)}>
              {categoryInfo.emoji}
            </span>
            <IconComponent
              className={cn(
