...
export function FriendLocationDetailsView({
  ...
  const images = (place as any).images || place.media?.map((m) => m.url) || [];
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-purple-300/70">Friend's location</p>
              </div>
              <Button
                variant="ghost"
                size="sm"
          ...
          >
            ...
            {rating && (
              <div className="flex items-center gap-1">
                ...
                <span className="font-medium text-[#EDEDED]">{rating}/5</span>
              </div>
            )}
          </div>
          ...
          >
            ...
            {note && (
              <div className="bg-purple-900/10 p-3 rounded-lg border border-purple-500/20">
                <p className="text-sm text-[#EDEDED] italic">"{note}"</p>
              </div>
            )}
        ...
        <div className="relative bg-gradient-to-r from-purple-900/80 to-purple-800/80 border-b border-purple-700/50 px-6 py-4 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-purple-200/70">Shared this location</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto bg-[#0C0C0C] custom-scrollbar">
          <div className="space-y-4 p-6">
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-[#EDEDED]">{place.name}</h2>
